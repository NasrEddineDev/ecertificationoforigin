                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <div class="toolbar add-product dt-tb">
                                ...
                                "PENDING") ? 'not-active' : '' }}" href="{{ route('managers.create') }}"
                                ...
                                <tbody>
                                    ...
                                    <tr id="{{ $manager->id }}">
                                        ...
                                        <td class="datatable-ct">
                                            <a rel="tooltip" class="btn btn-success" href="{{ route('managers.show',$manager->id) }}" 
                                                data-original-title="" title="{{ __('Detail') }}">
                                                <i class="fa fa-eye fa-lg" aria-hidden="true"></i>
                                                <div class="ripple-container"></div>
                                            </a>
                                            <a rel="tooltip" class="btn btn-primary" href="{{ route('managers.edit',$manager->id) }}" 
                                                data-original-title="" title="{{ __('Edit') }}">
                                                <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i>
                                                <div class="ripple-container"></div>
                                            </a>
                                            <a rel="tooltip" class="btn btn-danger pd-setting-ed" href="#" data-url="{{ route('managers.destroy',$manager->id) }}" 
                                            data-manager_name="{{ $manager->name }}" data-original-title="" title="{{ __('Delete') }}" data-toggle="modal" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>{{ __('Do you want to deletet the manager') }} <strong id="ManagerName" style="color: #d80027!important;"></strong> {{ __('forever') }} ?</p>
            </div>
