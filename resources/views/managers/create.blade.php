                                ...
                                <form class="form-sample" method="post" action="{{ route('products.store') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">
                                            <div class="form-group row">
                                                <label
                                                    class="col-sm-3 col-form-label {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">{{ __('Product Type') }}</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="category" id="category" class="form-control">
                                                        <option value='1'>
                                                            {{ __('Livestock, Livestock products and agricultural products') }}
                                                        </option>
                                                        ...
                                                        <option value='5'>{{ __('Energy and petrochemical products') }}
                                                        </option>
                                                        <option value='6'>
                                                            {{ __('Chemical, cosmetic, pharmaceutical and veterinary products') }}
                                                        </option>
                                                        <option value='7'>{{ __('Steel and metal products') }}</option>
                                                        <option value='8'>{{ __('Ferrous and non-ferrous waste') }}
                                                        </option>
                                                        <option value='9'>
                                                            {{ __('Equipment, materials and products of the mechanical industry') }}
                                                        </option>
                                                        <option value='10'>
                                                            {{ __('Electrical and electronic equipment and articles') }}
                                                        </option>
                                                        <option value='11'>{{ __('Building materials and ceramics') }}
                                                        </option>
                                                        <option value='12'>{{ __('Cork and wooden articles') }}</option>
                                                        <option value='13'>{{ __('Paper and cardboard') }}</option>
                                                        <option value='14'>{{ __('Publishing and graphic arts') }}
                                                        </option>
                                                        <option value='15'>{{ __('Leather goods, leathers and skins') }}
                                                        </option>
