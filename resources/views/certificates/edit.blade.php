                    ...
                    <div class="sparkline12-list">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br />
                                <form class="form-sample" method="post" action="{{ route('certificates.update', $certificate->id) }}"
                                                ...
                                                <div class="form-group col-lg-8 col-md-8 col-sm-8">
                                                    ...
                                                    <div class="col-md-6"
                                                        ...
                                                        <input name="invoice_date" id="invoice_date"
                                                            ...
                                                            class="form-control" value="{{ $certificate->invoice_date }}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <tbody>
                                                                @foreach ($certificate->products as $product)
                                                                    <tr id="{{ $product->pivot->id }}">
                                                                        ...
                                                                        <td>{{ $product->pivot->package_type }}</td>
                ...
                if ($(".form-sample").valid()) {
                    $.ajax({
                        ...
                        success: function(data) {
                            console.log(data.shipment_type);
                    ...
                    success: function(data) {
                        ...
                        $.each(data.products, function(index, product) {
                            $('#product_id').append('<option value="' + product.id +
                                '" data-measure_unit="' + product.measure_unit+'">' + product.name + ' ' + product.brand + '</option>');
                        })
                    }
                })
            });
