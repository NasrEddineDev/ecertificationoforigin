                                            ...
                                            <tr id="{{ $role->id }}">
                                                ...
                                                <td class="datatable-ct">
                                                    ...
                                                    <a rel="tooltip" class="btn btn-danger pd-setting-ed" href="#"
                                                        ...
                                                        data-role_name="{{ $role->name }}" data-original-title=""
                                                        title="Delete" data-toggle="modal" data-target="#DangerModalhdbgcl"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>{{ __('Do you want to delete the role') }} <strong id="roleName"
