                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <div class="toolbar add-product dt-tb">
                                ...
                                "PENDING") ? 'not-active' : '' }}" href="{{ route('roles.create') }}"
                                style="{{App()->currentLocale() == 'ar' ? 'right:auto;left: 35px;' : ''}}">{{ __('Add New Role') }}</a>
                                @endif
                            </div>
                            <!-- <div id="toolbar">
                                ...
                                <tbody>
                                    ...
                                    <tr id="{{ $role->id }}">
                                        ...
                                        <td class="datatable-ct">
                                            ...
                                            <a rel="tooltip" class="btn btn-danger pd-setting-ed" href="#" data-url="{{ route('roles.destroy',$role->id) }}" 
                                            data-role_name="{{ $role->name }}" data-original-title="" title="Delete" data-toggle="modal" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header header-color-modal bg-color-4">
                <h4 class="modal-title">{{ __('Delete the role') }}</h4>
...
<div id="PermissionsModalhdbgcl" class="modal modal-edu-general Customwidth-popup-WarningModal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
