            ...
            <div class="card-body">
              ...
              <form class="form-sample" method="post" action="{{ route('payments.store') }}">
                ...
                <div class="row">
                  <div class="col-md-6 {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">
                    <div class="form-group row">
                      <label class="col-md-3 col-form-label {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">
                        {{ __('Amount') }}
                      </label>
                      <div class="col-md-9">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                          ...
                          <select class="form-control" name="type" id="type" required>
                              <option value="" disabled>{{ __('Select the payment type') }}</option>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                          ...
                          <select class="form-control" name="mode" id="mode" required>
                              <option value="" disabled>{{ __('Select the payment mode') }}</option>
                ...
                <div class="row">
                  <div class="col-md-6 {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">
                    <div class="form-group row">
                      <label class="col-md-3 col-form-label {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">{{ __('Description') }}</label>
                      <div class="col-md-9">
                  ...
                  <div class="col-md-6 {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">
                    <div class="form-group row">
                      <label class="col-md-3 col-form-label {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">{{ __('Enterprise') }}</label>
                      <div class="col-md-9">
                        <select name="enterprise_id" id="enterprise_id" class="form-control" required>
                          ...
                          @foreach ($enterprises as $enterprise){
                              <option value="{{ $enterprise->id }}">{{ __($enterprise->name) }}
                              </option>
                          @endforeach
                        </select>
                      </div>
                      ...
                      <div class="col-lg-9">
                        <div class="login-horizental cancel-wp pull-left form-bc-ele">
                          <button type="submit" class="btn btn-white">
                            <a href="{{ route('payments.index') }}" style="color: inherit;">{{ __('Cancel') }}</a>
                          </button>
