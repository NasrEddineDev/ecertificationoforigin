                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px; margin-bottom:15px;">
                                            Congratulation! Mr.  <strong>{{$name}}</strong>, You have create a new bank account
                                        </p>
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            {{$body}}
                                        </p>
                                            ...
                                            <tr>
                                                <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <a href="www.issuer.bank.dz" style="color: #ffffff; text-decoration: none;">MY ACCOUNT</a>
                                                    </div>
                                                </td>
                                            </tr>
...
<div dir="ltr">
    ...
    <div style="width:190px;max-width:190px;font-family:&quot;Lucida Grande&quot;,Tahoma;font-size:12px;margin-top:0.5em;color:rgb(102,102,102);letter-spacing:2px;border-left:2px solid rgb(211,216,215);padding-top:3px;padding-left:10px;overflow:hidden">
        ...
        <p>
           <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">contact@issuer.bank.dz</a>
        </p> 
        <p style="margin-top:10px;margin-bottom:10px;">
            <a href="http://www.issuer.bank.dz/" style="margin-top:0.5em;color:rgb(102,102,102);text-decoration:none" target="_blank">www.issuer.bank.dz</a>&nbsp;<br>
        </p>
        <p>
            <a href="https://www.linkedin.com/issuer.bank.dz" style="margin-top:0.5em;color:rgb(102,102,102);text-decoration:none" target="_blank">
                <img src="https://cdn3.iconfinder.com/data/icons/free-social-icons/67/linkedin_circle_gray-24.png">
            </a>&nbsp;
            <a href="https://twitter.com/issuer.bank.dz" style="margin-top:0.5em;color:rgb(102,102,102);text-decoration:none" target="_blank">
                <img src="https://cdn3.iconfinder.com/data/icons/free-social-icons/67/twitter_circle_gray-24.png">
            </a>&nbsp;
            <a href="https://plus.google.com/issuer.bank.dz" style="margin-top:0.5em;color:rgb(102,102,102);text-decoration:none" target="_blank">
