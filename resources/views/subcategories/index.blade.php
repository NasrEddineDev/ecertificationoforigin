                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <div class="toolbar add-product dt-tb">
                                ...
                                style="{{App()->currentLocale() == 'ar' ? 'right:auto;left: 35px;' : ''}}">{{ __('Add New Sub-Category') }}</a>
                                @endif
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr id="{{ $subcategory->id }}">
                                        ...
                                        <td class="datatable-ct">
                                            ...
                                            <a rel="tooltip" class="btn btn-success" href="{{ route('categories.show',$subcategory->id) }}" data-original-title="" title="View">
                                                <i class="fa fa-eye fa-lg" aria-hidden="true"></i>
                                                <div class="ripple-container"></div>
                                            </a>
                                            @endcan
                                            @can('update',  App\Models\SubCategory::class)
                                            <a rel="tooltip" class="btn btn-primary" href="{{ route('categories.edit',$subcategory->id) }}" data-original-title="" title="Edit">
                                                <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i>
                                                <div class="ripple-container"></div>
                                            </a>
                                            @endcan
                                            @can('delete',  App\Models\SubCategory::class)
                                            <a rel="tooltip" class="btn btn-danger pd-setting-ed" href="#" data-url="{{ route('subcategories.destroy',$subcategory->id) }}" 
                                            data-category_name="{{ App()->currentLocale() == 'ar' ? $subcategory->name_ar : (
                                                App()->currentLocale() == 'en' ? $subcategory->name : $subcategory->name_fr)}}" data-original-title="" title="Delete" data-toggle="modal" 
