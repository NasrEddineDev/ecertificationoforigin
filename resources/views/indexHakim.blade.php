                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                  ...
                                  <!--  <li class="nav-item">
                                        ...
                                        <div role="menu" class="notification-author dropdown-menu animated zoomIn"
                                            ...
                                            <form class="px-4 py-3"  method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    id="email" name="email" placeholder="البريد اﻹلكتروني">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-check col-lg-5" style="float:left">
                                                    <input type="checkbox" class="form-check-input" style="margin-right:-20px;"
                                                ...
                                                <div class="col-lg-6" style="float:right">
                                                    <a class="dropdown" style="padding: 0px;font-size:12px!important;color:#581CCB"
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="{{ route('registration_wizard') }}">حساب جديد</a>
                                    </li>
                                </ul>
                            </div> <!-- navbar collapse -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="header_hero_content mt-45">
                            <h2 class="header_title wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.2s">شهادة  المنشأ الإلكترونية</h2>
                            <p class="wow fadeInLeftBig" id="text1" data-wow-duration="1.3s" data-wow-delay="0.6s" dir="rtl">هي وثيقة تجارية تسلم بعد ان يتم توقيعها إلكترونيا على المنصة الجديدة للغرفة الجزائرية للتجارة والصناعة وذلك بناء على طلب من المصدرين المسجلين في هذه الاخيرة، تسمح شهادة المنشأ الإلكترونية لإثبات منشأ سلعته والاستفادة من المزايا و التفضيلات التعريفية.</p>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single_features mt-30 features_1 text-center wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        ...
                        <div class="features_content">
                            ...
                            <p id="T1">نظرًا لأن توفير الوقت هو الشاغل الرئيسي ، فإن الهدف كله هو تجنب نفقات السفر والوقت. ستتيح هذه المنصة معالجة جميع مستنداتك عبر الإنترنت واعتمادها.</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single_features mt-30 features_2 text-center wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        ...
                        <div class="features_content">
                            ...
                            <p id="T1">بفضل التصديق ، تم اعتماد مستندات AGCE الخاصة بطرف ثالث والتي تم إنشاؤها من هذا النظام الأساسي وبالتالي فهي قابلة للتطبيق في المحكمة.</p>
                        </div>
                    </div> <!-- single featuresow -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single_features mt-30 features_3 text-center wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.9s">
                        ...
                        <div class="features_content">
                            ...
                            <p id="T1">مصمم ليكون سهل الاستخدام قدر الإمكان ، يتطلب التطبيق القليل من إدخال المستخدم ، ما عليك سوى ملء المستندات.</p>
                        </div>
                    </div> <!-- single featuresow -->
                </div>
            </div> <!-- row -->
                ...
                <div class="stepwizard-row setup-panel">
                  <div class="row" id="steps">
                        <div class="stepwizard-step col-lg-4 col-sm-12"> 
                            ...
                            <p class="stepper-description" id="T2">في هاته المرحلة يتم ملأ  كل المعلومات الخاصة بالمصدر و المصادقة عليها   
                                ابدأ بالتسجيل في المنصة                                 
                                <a href="http://certest.caci.dz">شهادة المنشأ الإلكترونية</a>.</p></div>
                                <div class="stepwizard-step col-lg-4 col-sm-12"> <button type="button" class="btn btn-primary btn-circle">2</button>
                                    <p class="text-primary bold" id="T1">القيام بالمصادقة على الشروط العامة لانشاء حساب</p>
                                    <p class="stepper-description" id="T2">في هاته المرحلة يتم التوقيع على الشروط العامة عبر الإنترنت عند إنشاء حساب.  وبمجرد تنشيط هذا الأخير من قبل الغرفة التجارة، سيتلقى المصدر معلومات تسجيل دخول تتيح له الوصول إلى المنصة
                                        و طلب الخدمة .
                                        </p></div>
                                    <div class="stepwizard-step col-lg-4 col-sm-12"> <button type="button" class="btn btn-primary btn-circle">3</button>
                                        <p class="text-primary bold" id="T1">التقدم بالطلب للحصول على شهادة المنشأ الإلكترونية و استخراجها</p><p class="stepper-description" id="T2">و  لكي يستفيد المصدر من هاته الخدمة  الإلكترونية المقدمة يتم اختيار نوع الشهادة  و إدخال كافة المعلومات العامة للحصول على شهادة المنشأ و توقيع عليها من طرف المصدر, بعدها يقوم العامل المؤهل من تأكد من المعلومات وقيام بتوقيع إلكتروني باستخدام المنصة السلطة الحكومية لتوقيع الكتروني و بتالي سيتحصل المصدر على شهادة المنشأ الإلكترونية المقبولة قانونيا و قابلة لتحقق من  صحته  . 
                                             </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <h2 class="step-head1"> معاينة شهادت المنشأ</h4>
                                          <div class="row" id="steps1">
                                            ...
                                            <form class="form-inline" id="searching">
                                                <input class="form-control mr-sm-2" type="search" placeholder="الرجاء إدخال رقم شهادت المنشأ" aria-label="Search" id="searching">
