        ...
        <div id="page1">
            <div id="tables">
                <table style="width:100%;padding-top:200px!important;">
                    <tr>
                        <td width="50%" style="height: 38px;margin-left:5px!important;margin-right:5px!important;text-align:center;font-weight: bold;">
                            {{-- <td width="50%" style="height: 38px;background-color:rgba(255, 0, 0, 0.5);margin-left:5px!important;margin-right:5px!important;text-align:center;font-weight: bold;"> --}}
                                {{ $code }}
                        </td>
                ...
                <table style="width:100%;padding-top:22px;">
                    ...
                    <tr>
                        ...
                        <td width="26%" style="margin-left:10px;height: 38px;font-weight: bold;text-align:left;padding-right:10px;">
                            <strong>
                                {{ $original_country }}
                            </strong>
                        </td>
                ...
                <table style="width:100%;margin-top:19px;">
                    <tr>
                        ...
                        <td width="50%" style="{{ $rtl ? 'text-align:right;text-align:center;' : '' }}font-weight: bold;">{{ __($shipment_type) }}</td>
                    </tr>
                </table>
                <table style="width:100%;margin-top:21px;">
                    <tr>
                        <td width="19%" style="font-size:11px;height: 360px;{{ $rtl ? 'text-align:right;' : '' }}font-weight: bold;">
                            {{ $rtl ? 'رقم الفاتورة' : 'Invoice Number' }}<br />
                            {{ $invoice_number }}<br />
                            {{ $rtl ? 'تاريخ الفاتورة' : 'Invoice Date' }}<br />
                            {{ $invoice_date }}
                        </td>
                        <td width="17%" style="font-size:11px;{{ $rtl ? 'text-align:right;' : '' }}font-weight: bold;">
