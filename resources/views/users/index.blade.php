                        ...
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <thead>
                                    <tr>
                                        ...
                                        <th data-field="signature" data-editable="true">{{ __('Signature') }}</th>
                                        <th data-field="round_stamp" data-editable="true">{{ __('Round Stamp') }}</th>
                                        <th data-field="square_stamp" data-editable="true">{{ __('Square Stamp') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr id="{{ $user->id }}">
                                        ...
                                        <td>{{ $user->profile->signature }}</td>
                                        <td>{{ $user->profile->round_stamp }}</td>
                                        <td>{{ $user->profile->square_stamp }}</td>
                                        <td class="datatable-ct">
                                            <a rel="tooltip" class="btn btn-success" href="{{ route('users.show',$user->id) }}" data-original-title="" title="View">
                                                <i class="fa fa-eye fa-lg" aria-hidden="true"></i>
                                                <div class="ripple-container"></div>
                                            </a>
                                            <a rel="tooltip" class="btn btn-primary" href="{{ route('users.edit',$user->id) }}" data-original-title="" title="Edit">
                                                <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i>
                                                <div class="ripple-container"></div>
                                            </a>
                                            <a rel="tooltip" class="btn btn-danger pd-setting-ed" href="#" data-url="{{ route('users.destroy',$user->id) }}" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>{{ __('Do you want to deletet the user') }} <strong id="userName" style="color: #d80027!important;"></strong> {{ __('forever') }} ?</p>
            </div>
